    ...
    io.on('connection', (socket) => {
        ...
        socket.on('change', delta => {
            ...
            if (sessionId in collaborations) {
                ...
                console.log('warning: could not find socket id to any collaboration')
            }
        });
        ...
        socket.on('restoreBuffer', () => {
            ...
            if (sessionId in collaborations) {
                ...
                console.log('warning: could not find socket if in collaborations');
            }
        });
        socket.on('disconnect', function() {
            ...
            if (sessionId in collaborations) {
                ...
                if (index >= 0) {
                    ...
                    if (participants.length == 0) {
                        console.log("last participant in collaboration leaves");
            ...
            if (!foundAndRemoved) {
                console.log('could not find any socket')
            }
        })
    });
}